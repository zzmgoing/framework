...
public final class RecyclerViewAttacher extends RecyclerView.OnScrollListener implements ListPreloader.Attacher {
    ...
    public RecyclerViewAttacher(@NonNull RecyclerView recyclerView, @NonNull VisiblePositionFinder visiblePositionFinder) {
        this.recyclerView = Util.requireNonNull(recyclerView, "recyclerView is null");
        this.visiblePositionFinder = Util.requireNonNull(visiblePositionFinder, "visiblePositionFinder is null");
    }

    @Override
    public void attach(@NonNull ListPreloader preloader) {
        this.preloader = Util.requireNonNull(preloader, "preloader is null");
    ...
    public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
        RecyclerView.Adapter<?> adapter = Util.checkNotNull(recyclerView.getAdapter(), "RecyclerView has no Adapter");
        RecyclerView.LayoutManager layoutManager = Util.checkNotNull(recyclerView.getLayoutManager(), "RecyclerView has no LayoutManager");
        ...
        ListPreloader preloader = Util.checkNotNull(this.preloader, "Not attached");
